...
if __name__ == "__main__":
    ...
    generate_line_plot(merge_sort_df, title='Merge Sort', xlabel='Input Size', ylabel='Running Time',
                       file_name='merge_sort_line_plot.pdf')

    # Generating and save line plot for Quicksort
    generate_line_plot(quicksort_df, title='Quicksort', xlabel='Input Size', ylabel='Running Time',
